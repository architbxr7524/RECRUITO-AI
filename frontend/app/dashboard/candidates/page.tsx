...
export default function CandidatesPage() {
  ...
  useEffect(() => {
    ...
    const url = search
      ? `https://recruito-ai-production.up.railway.app/api/v1/candidates?search=${encodeURIComponent(search)}`
      : `https://recruito-ai-production.up.railway.app/api/v1/candidates?limit=50`
